        ...
        <div >
            <Avatar className="size-36 absolute  border-white -translate-y-1/2">
                <div className='relative'>
                    ...
                    {/* ⚠️ 这里是修改的地方 */}
                    <div className=' absolute z-20 w-8 h-8 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex justify-center items-center bg-white hover:bg-gray-700 rounded-full'
