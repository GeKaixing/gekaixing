      ...
      <div className="prose max-w-none">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>**个人身份信息**：当您注册、下单或填写表格时，我们可能会收集您的姓名、电子邮件地址、电话号码、送货地址和账单地址。</li>
            <li>**支付信息**：当您进行购买时，我们通过安全的第三方支付处理服务商（例如：Stripe, PayPal）收集和处理您的支付信息。我们不会存储您的信用卡信息。</li>
            <li>**非个人身份信息**：我们可能会自动收集非个人身份信息，例如您的 IP 地址、浏览器类型、操作系统、访问时间以及您在我们网站上浏览过的页面。这些信息用于分析网站流量和改进用户体验。</li>
          </ul>
        </section>
