  ...
  return (
    <>
      ...
      <div className="container mx-auto p-4 md:p-8">
        <Head>
          <title>Cookie 使用政策 | Gekaixing</title>
          <meta name="description" content="Gekaixing 的 Cookie 使用政策，说明我们如何使用 Cookie 以及用户如何管理偏好。" />
        </Head>

        <div className="prose max-w-none">
          <h1 className="text-3xl font-bold mb-6">Gekaixing Cookie 使用政策</h1>
          <p className="text-sm text-gray-500 mb-8">
            更新日期：2025年8月4日
          </p>

          <p className="mb-4">
            本政策解释了 <strong>Gekaixing</strong> 如何在您的设备上使用 Cookie 和其他类似技术。通过继续使用我们的网站，即表示您同意我们根据本政策使用 Cookie。
          </p>
